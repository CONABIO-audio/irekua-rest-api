...
from .object_types.data_collections.collection_administrators import (
    CollectionTypeAdministratorViewSet,
)
from .object_types.data_collections.collection_annotation_types import (
    CollectionTypeAnnotationTypeViewSet,
)
from .object_types.data_collections.collection_licence_types import (
    CollectionTypeLicenceTypeViewSet,
)
from .object_types.data_collections.collection_sampling_event_types import (
    CollectionTypeSamplingEventTypeViewSet,
)
from .object_types.data_collections.collection_site_types import (
    CollectionTypeSiteTypeViewSet,
)
from .object_types.data_collections.collection_event_types import (
    CollectionTypeEventTypeViewSet,
)
from .object_types.data_collections.collection_types import CollectionTypeViewSet
from .object_types.data_collections.collection_item_types import (
    CollectionTypeItemTypeViewSet,
)
from .object_types.data_collections.collection_device_types import (
...
from .object_types.sampling_events.sampling_event_type_device_types import (
    SamplingEventTypeDeviceTypeViewSet,
)
from .object_types.sampling_events.sampling_event_type_site_types import (
