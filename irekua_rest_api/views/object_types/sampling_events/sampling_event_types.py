...
class SamplingEventTypeViewSet(
    ...
    serializer_mapping = utils.SerializerMapping.from_module(
        serializers.object_types.sampling_events.types
    ).extend(
    ...
    def get_object(self):
        ...
        sampling_event = get_object_or_404(
            models.SamplingEventType, pk=sampling_event_pk
        )
    ...
    def get_queryset(self):
        if self.action == "device_types":
            ...
            queryset = models.SamplingEventTypeDeviceTypeViewSet.objects.filter(  # pylint: disable=E1101
                sampling_event_type=sampling_event_type_id
            )
            return queryset
