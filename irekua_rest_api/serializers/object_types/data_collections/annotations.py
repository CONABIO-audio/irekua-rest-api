...
class ListSerializer(IrekuaModelSerializer):
    annotation_type = serializers.PrimaryKeyRelatedField(
        many=False, read_only=True, source="annotationtype"
    )
    icon = serializers.ImageField(source="annotationtype.icon")
    annotation_schema = serializers.JSONField(source="annotationtype.annotation_schema")
    name = serializers.SlugRelatedField(
        read_only=True, source="annotationtype", slug_field="name"
    )
