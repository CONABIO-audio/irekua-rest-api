...
class SelectSerializer(IrekuaModelSerializer):
    id = serializers.PrimaryKeyRelatedField(
        many=False, read_only=False, queryset=Item.objects.all()
...
class DetailSerializer(IrekuaModelSerializer):
    ...
    annotations = annotation_serializers.DetailSerializer(
        many=True, read_only=True, source="annotation_set"
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        try:
            ...
            if collection_type.restrict_item_types:
                item_type_field.queryset = collection_type.item_types.all()
