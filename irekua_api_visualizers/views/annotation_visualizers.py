...
class AnnotationVisualizersViewSet(IrekuaModelViewSet):
    ...
    queryset = AnnotationVisualizer.objects.all()

    serializer_class = serializers.AnnotationVisualizerSerializer
